...
PICS = (environ.get('PICS', 'https://envs.sh/7M-.jpg https://envs.sh/7Mm.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7170452349 5643587914').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002312992675'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002330595274').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002437733231') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002286866270')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002330595274')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://freefiretournament334:jv9GzXRW70ZG2yfv@cluster0.ji5zn.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "afmhakal")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'venomfile')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/allmovies516')
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', 'd72a21ce05839e8af9519a05976bfe6982299e73')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/newmoviesall10/6')

# If You Fill Second Shortner Then Bot Attach Both First And Second Shortner And Use It For Verify.
VERIFY_SECOND_SHORTNER = bool(environ.get('VERIFY_SECOND_SHORTNER', False))
# if verify second shortner is True then fill below url and api
VERIFY_SND_SHORTLINK_URL = environ.get('VERIFY_SND_SHORTLINK_URL', 'modijiurl.com')
VERIFY_SND_SHORTLINK_API = environ.get('VERIFY_SND_SHORTLINK_API', 'd72a21ce05839e8af9519a05976bfe6982299e73')


# Shortlink Info
SHORTLINK_MODE = bool(environ.get('SHORTLINK_MODE', True)) # Set True Or False
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'arolinks.com')
SHORTLINK_API = environ.get('SHORTLINK_API', '77a750837d60d67559fb72c8f22c92ab0397370f')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/newmoviesall10/10') # How Open Shortner Link Video Link , Channel Link Where You Upload Your Video.
